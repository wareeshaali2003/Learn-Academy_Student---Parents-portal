...
export function useStudentSchedule(studentId: string | null | undefined) {
  ...
  const load = useCallback(async () => {
    ...
    setError(null);
    try {
      // Resolve academic year once per studentId change, then cache it.
      ...
      if (!academicYear) {
        if (requestId === requestIdRef.current) {
          setError('Academic year student ke Program Enrollment se resolve nahi ho saka');
          setEntries([]);
        }
        return;
      }
      ...
      // Guard against race conditions from rapid studentId switches
  ...
  // Reset cached academic year whenever the student changes (guardian switching child)
  useEffect(() => {
        ...
        <div className="h-24 bg-linear-to-r from-green-600 via-emerald-500 to-teal-500 relative flex items-end px-6 pb-4">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div>
              ...
              {/* Academic Year label is now dynamic instead of hardcoded */}
